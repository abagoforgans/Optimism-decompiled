...
#  - _fallback()
#
const isTokenRouter = 0

const isTokenBridge = 1
...
uint8 sub_ed47ff17; offset 160
uint8 sub_afeb80ab; offset 168
uint128 stor5; offset 168
uint128 stor5; offset 160
address routerAddress;
address sub_bbc6a3d8Address;
...
function sub_afeb80ab(?) {
    return bool(sub_afeb80ab)
}

function sub_bbc6a3d8(?) {
    return sub_bbc6a3d8Address
}

function sub_ed47ff17(?) {
    return bool(sub_ed47ff17)
}
...
function _setRouter(address arg1) {
    require calldata.size - 4 >= 32
    require arg1 == arg1
...
function sub_79342bd5(?) {
    require calldata.size - 4 >= 32
    require arg1 == address(arg1)
    if roleAdmin[0xfea49807205ce4d355092ef5a8a18f56e8913cf4a201fbe287825b095693c217][address(msg.sender)].field_0:
        sub_bbc6a3d8Address = address(arg1)
    idx = 41
    s = address(msg.sender)
    while idx > 1:
        if s % 16 >= 16:
...
function setInboundEnable(bool arg1) {
    require calldata.size - 4 >= 32
    require arg1 == arg1
    if roleAdmin[0xfea49807205ce4d355092ef5a8a18f56e8913cf4a201fbe287825b095693c217][address(msg.sender)].field_0:
        Mask(88, 0, stor5.field_168) = Mask(88, 0, arg1)
        emit StatusUpdated('inboundEnable', bool(sub_afeb80ab), bool(0 or uint8(arg1)));
    idx = 41
    s = address(msg.sender)
    while idx > 1:
        if s % 16 >= 16:
...
function setOutboundEnable(bool arg1) {
    require calldata.size - 4 >= 32
    require arg1 == arg1
    if roleAdmin[0xfea49807205ce4d355092ef5a8a18f56e8913cf4a201fbe287825b095693c217][address(msg.sender)].field_0:
        Mask(96, 0, stor5.field_160) = Mask(96, 0, arg1)
        emit StatusUpdated('outboundEnable', bool(sub_ed47ff17), bool(0 or uint8(arg1)));
    idx = 41
    s = address(msg.sender)
    while idx > 1:
        if s % 16 >= 16:
